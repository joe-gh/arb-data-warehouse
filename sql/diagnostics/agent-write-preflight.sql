...
WITH writable_table(schema_name, table_name) AS (
    VALUES
        ...
        ('catmgr', 'snapshot'),
        ('catmgr', 'wp_term'),
        ('catmgr', 'wp_term_product'), ('catmgr', 'wp_uncategorized_product'),
        ('catmgr', 'audit_log'),
        ('catmgr', 'node'),
...
WITH writable_table(schema_name, table_name) AS (
    VALUES
        ...
        ('woo', 'stock_override'), ('woo', 'color_price_override'), ('woo', 'virtual_catalog_store'),
        ('logo', 'assignment_tombstone'),
        ('catmgr', 'snapshot'), ('catmgr', 'wp_term'),
        ('catmgr', 'wp_term_product'), ('catmgr', 'wp_uncategorized_product'), ('catmgr', 'audit_log'),
...
WITH table_policy(schema_name, table_name, policy) AS (
    VALUES
        ...
        ('woo', 'color_price_override', 'crud'),
        ('woo', 'virtual_catalog_store', 'crud'),
        ('logo', 'assignment_tombstone', 'crud'),
        ('catmgr', 'snapshot', 'crud'),
        ('catmgr', 'wp_term', 'crud'),
        ('catmgr', 'wp_term_product', 'crud'), ('catmgr', 'wp_uncategorized_product', 'crud'),
        ('catmgr', 'node', 'crud'),
...
restore_table_policy(schema_name, table_name) AS (
    ...
    VALUES
        ...
        ('woo', 'color_price_override', 'fdm4_store', 'text', false, '', NULL),
        ('woo', 'color_price_override', 'style_code', 'text', false, '', NULL),
        ('woo', 'color_price_override', 'color_code', 'text', false, '', NULL),
        ('woo', 'color_price_override', 'price', 'numeric(10,2)', false, '', NULL),
        ('woo', 'color_price_override', 'note', 'text', false, '', ''''''),
        ('woo', 'color_price_override', 'active', 'boolean', false, '', 'true'),
        ('woo', 'color_price_override', 'updated_by', 'text', false, '', ''''''),
        ('woo', 'color_price_override', 'updated_at', 'timestamp with time zone', false, '', 'now()'),
    ...
    VALUES
        ...
        ('woo', 'color_price_override', ARRAY['fdm4_store', 'style_code', 'color_code', 'price', 'note', 'active', 'updated_by', 'updated_at']::text[]),
    ...
    VALUES
        ...
        ('woo.color_price_override|color_price_override_pkey|p|fdm4_store,style_code,color_code||||||'),
